# This Makefile is for the Module::Install::DBICx::AutoDoc extension to perl.
#
...
#     NAME => q[Module::Install::DBICx::AutoDoc]
#     NO_META => q[1]
#     PL_FILES => {  }
...
FULLEXT = Module/Install/DBICx/AutoDoc
BASEEXT = AutoDoc
PARENT_NAME = Module::Install::DBICx
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
LDFROM = $(OBJECT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Module/Install/DBICx/AutoDoc.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Module/Install/DBICx
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Module/Install/DBICx
...
TO_INST_PM = lib/Module/Install/DBICx/AutoDoc.pm

PM_TO_BLIB = lib/Module/Install/DBICx/AutoDoc.pm \
	blib/lib/Module/Install/DBICx/AutoDoc.pm
...
DISTVNAME = Module-Install-DBICx-AutoDoc-0.02
...
manifypods : pure_all  \
	lib/Module/Install/DBICx/AutoDoc.pm \
	lib/Module/Install/DBICx/AutoDoc.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Module/Install/DBICx/AutoDoc.pm $(INST_MAN3DIR)/Module::Install::DBICx::AutoDoc.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' \
	  lib/Module/Install/DBICx/AutoDoc.pm blib/lib/Module/Install/DBICx/AutoDoc.pm 
